...
10 min: (**Rob):** Intro to the seminar (purpose, where to find course materials, office hours for extra help, etc)

10 min: (**Sarah):** what is computer science? how do we learn about computers and computer languages? What is the learning process of how to program. Things break and don't work. OK. Very easy to make mistakes, very hard to make irrecoverable mistakes.

10 min (**Rob)**: Why we use computers: reproducibility, transparency, sharing/collaborating, and computational power (maaaaathhhh speed) publishing (how does this differ from Sarah's bit above?)

BREAK (10 min?)

15 min (**Rob**): An example what what you should be able to to at the end of the course,

10 min: (**Sarah**) Variable vs. Function: Example problem (work this together): write a quick "hello world" function.
...
10 minutes: **(Rob)** When is programming useful? Why R (FREE! packages, functions, community of developers and helpers). Rstudio (R vs IDE)

25-30 minutes: **(Sarah)** R mechanics

-   understand what a variable is (and how to assign a variable)

-   understand what a function is (inputs and outputs)

    -   how to access documentation

Break (10 min)

15 min: **(Rob)** packages and data import (xlsx vs csv): differences, data loss, analyzable vs. unanalyzable data in xlsx (color yuck!)

15 min: (Rob) get data and import it (from packages; from files)

Challenge: do it again, but on your own?

## Lecture 3: June 18

Data handling/best practices What to do and how to treat raw data files Hit data import again Exploring/munging data: comment & document code anatomy of a dataframe: head/tail nrow/ncol how to find a specific location in a dataframe subsetting data joining data with rbind/cbind simple operations within a data frame (col1 \* col2 = col3) factors how to save/export a file:
...
examples? challenge problems?

## Lecture 5: June 25

Statistics in brief: Normal distributions; p-values, 95% probability, etc (cover at a very high level - not too many details) distribution shapes and simple transformations (histograms? QQplots?)

## Lecture 6: June 26

maybe this needs more detail.
