...
10 minutes: **(Rob)** When is programming useful? Why R (FREE! packages, functions, community of developers and helpers)
...
15 min: **(Rob)** data import (xlsx vs csv): differences, data loss, analyzable vs. unanalyzable data in xlsx (color yuck!)
